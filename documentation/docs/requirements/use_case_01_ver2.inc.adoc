...
# 2.5. Use-Case 01:Kalender und Sidebar-Menü übersehen


=== Kurzbeschreibung

Dieser Use-Case beschreibt die Kalenderansicht zur Visualisierung geplanter Bei Unterbrechung der Internetverbindung werden Änderungen nicht gespeichert.
