...
* UC01: Mitarbeiter Projekten zuordnen
* UC02: Kurzfristige und langfristige Abwesenheitszeiten in    der Einsatzplanung eintragen
* UC03: Personenbezogene Daten ändern
* UC04: Projekt erstellen
* UC05: Projektbezogene Daten ändern
* UC06: Ändern von Nutzer- und Zugriffsrechten 
* UC07: Importieren und Exportieren von Daten
