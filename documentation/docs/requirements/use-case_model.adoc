...
* UC01: Erstellung von Projekten
* UC02: Projektbezogene Daten ändern
* UC03: Hinzufügen von Aufgaben in Projekten
* UC04: Verwaltung von kurzftigen und langfristigen Abwesenheitszeiten
* UC05: Verwaltung personenbezogener Daten
...
<<<
include::use_case_03.adoc[]

<<<
include::use_case_04.adoc[]

<<<
include::use_case_05.adoc[]

<<<
include::use_case_06.adoc[]
