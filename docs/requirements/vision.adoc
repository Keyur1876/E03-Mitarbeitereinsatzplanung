...
. Die Bearbeitungszeit ist abhängig von der Art der Änderungen (Urlaub, Krankheitsfall, Mitarbeit an mehreren Projekten gleichzeitig), die in der Arbeitszeitplanung des jeweiligen Mitarbeiters berücksichtigt werden müssen. 
