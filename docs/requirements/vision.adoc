...
[cols="1,3"]
|===
| Das Problem | Im aktuellen Excel-Sheet müssen alle Änderungen wie Feiertage, Urlaube, Abwesenheiten händisch eingetragen werden. Außerdem gibt es kein Rechte- und Rollenmanagement, sowie keine Möglichkeit eine sinnvolle Auslastungsplanung vorzunehmen.
| betrifft | die Geschäftsführer, sowie die Mitarbeiter der Firma Develappers GmbH
...
//ich weiß nicht wie ich richtige Stichpunkte setzen kann
...
[cols="1,3"]
|===
| Für | Arbeitnehmer und Arbeitgeber der Firma Develappers GmbH
...
| Unser Produkt | ermöglicht eine automatisierte Planung von Mitarbeitenden über kurze und lange Spannen mit dem Augenmerk auf eine gleichmäßige Auslastung 
|===
...
| Auftraggeber
| Leiter der Softwareentwicklung und der Sicherheitsbeauftragte des Unternehmens Develappers GmbH
| Ansprechpartner für das Projekt, die
die Anforderungen an das Tool festlegen.
| Arbeitende des Unternehmens
| Alle Mitarbeiter der Develappers GmbH
